...
#define N 780
#define K 6  //Aquest K representarà el nombre de cossos, si es vol afegir més s'haurà de canviar el número
...
int main(){
    ...
    m[4]=mnorm(86.813*pow(10,24));
    m[5]=mnorm(102.409*pow(10,24));
    ...
    A[4][0][0]=rnorm(2.197*pow(10,12));
    A[4][1][0]=rnorm(1.972*pow(10,12));
    A[4][2][0]=vnorm(-4.6*pow(10,3));
    A[4][3][0]=vnorm(4.75*pow(10,3));
    A[4][4][0]=rnorm(-2.113*pow(10,10));
    A[4][5][0]=vnorm(7.72*pow(10,1)); 

    A[5][0][0]=rnorm(4.425*pow(10,12));
    A[5][1][0]=rnorm(-6.627*pow(10,11));
    A[5][2][0]=vnorm(7.691*pow(10,2));
    A[5][3][0]=vnorm(5.408*pow(10,3));
    A[5][4][0]=rnorm(-8.833*pow(10,10));
    A[5][5][0]=vnorm(-1.291*pow(10,2)); 
    ...
    output=fopen("C:\\Users\\surfi\\Desktop\\MN practica 1\\Tr(3D_6C(ura,neptu)_1dia).txt","w"); // w de write
